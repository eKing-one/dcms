...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `ank_o_par` varchar(215) DEFAULT NULL,
  `ank_zan` varchar(215) DEFAULT NULL,
  `ank_smok` int(11) DEFAULT NULL,
  `ank_mat_pol` int(11) DEFAULT NULL,
  `ank_proj` int(11) DEFAULT NULL,
  `ank_baby` int(11) DEFAULT NULL,
  `ank_avto` varchar(215) DEFAULT NULL,
