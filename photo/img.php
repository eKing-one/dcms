...
if ($size == '48')
{
	if (is_file(H.'files/gallery/48/'.$if_photo.'.png'))
	{
...
if ($size == '128')
{
	if (is_file(H.'files/gallery/128/'.$if_photo.'.jpg'))
	{
...
if ($size == '50')
{
	if (is_file(H.'files/gallery/50/'.$if_photo.'.jpg'))
	{
...
if ($size == '640')
{
	if (is_file(H.'files/gallery/640/'.$if_photo.'.jpg'))
	{
...
if ($size == '0')
{
	if (is_file(H.'files/gallery/photo/'.$if_photo.'.jpg'))
	{
