...
/**
 * 该函数试图以UTF-8编码检测HTML文本中是否存在粗言秽语（淫秽，淫秽词语）。
 * 如果没有检测到配偶，则返回false，否则是带有脏话的文本片段。
 *
 * 该算法非常可靠和快速，包括大量数据。
 * 检测配偶的方法是基于俄语的词根和介词，而不是字典。
 * 单词"sucker"，"dick"，"prick"，"bitch"不被认为是脏话（见Dahl's dictionary）
 *
 * http://www.google.com/search?q=%F2%EE%EB%EA%EE%E2%FB%E9%20%F1%EB%EE%E2%E0%F0%FC%20%F0%F3%F1%F1%EA%EE%E3%EE%20%EC%E0%F2%E0&ie=utf8&oe=UTF-8
