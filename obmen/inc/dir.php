...
{
$k_f=$k_f+dbresult(dbquery("SELECT COUNT(*) FROM `obmennik_files` WHERE `id_dir` = '$post2[id]'"),0);
$k_n=$k_n+dbresult(dbquery("SELECT COUNT(*) FROM `obmennik_files` WHERE `id_dir` = '$post2[id]' AND `time_go` > '" . $ftime . "'",$db), 0);
}
