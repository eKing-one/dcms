...
账号:<br /><input type="text" name="login" maxlength="32" /><br />
密码:<br /><input type="password" name="pass" maxlength="32" /><br />
<label><input type="checkbox" name="aut_save" value="1" />记住我</label><br />
<input type="submit" value="登录" />
</form>
<div class="foot">尚未登记？ <br /><a href="/user/reg.php">注册账号</a><br /></div>
<div class="foot">忘记密码？<br /><a href="/user/pass.php">密码恢复</a><br /></div>';
