...
echo '<b>原因:</b> '.$pBan[$post['pochemu']].'<br />';echo '<b>章:</b> '.$rBan[$post['razdel']].'<br />';echo '<b>评论:</b> '.esc(trim(br(bbcode(smiles(links(stripcslashes(htmlspecialchars($post['prich']))))))))."<br />\n";if ($post['time']>$time)echo "<font color=red><b>Активен</b></font><br />\n";
