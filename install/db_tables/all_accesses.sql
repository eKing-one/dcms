...
('down_dir_delete', '下载中心-删除文件夹'),
('down_dir_edit', '下载中心-文件夹管理'),
('down_dir_create', '下载中心-创建文件夹'),
('down_file_delete', '下载中心-删除文件'),
('down_file_edit', '下载中心-文件编辑'),
('down_komm_del', '交换-删除注释'),
('photo_photo_edit', '照片库-编辑/删除照片'),
('photo_alb_del', '照片库-删除相册'),
('photo_komm_del', '照片库-删除评论'),
